...
create table if not exists __saga (
    ...
    result_type varchar(255) not null default '',
    exception clob,
    compensation_request_code varchar(255) not null default '',
    compensation_request_reason clob,
    compensation_requested_at timestamp default null,
    compensation_requested_by varchar(32) not null default '',
    compensation_source_process_code varchar(255) not null default '',
    expire_at timestamp not null default current_timestamp,
    create_at timestamp not null default current_timestamp,
...
create table if not exists __saga_process (
    ...
    compensation_code varchar(255) not null default '',
    compensation_param clob,
    compensation_param_type varchar(255) not null default '',
    compensation_result clob,
    compensation_result_type varchar(255) not null default '',
    compensation_exception clob,
    compensation_state int not null default 0,
    compensation_last_try_time timestamp default null,
    compensation_tried_times int not null default 0,
    compensated_at timestamp default null,
